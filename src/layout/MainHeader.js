    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          <li class="nav-item">
<a className="nav-link active" href="https://richi-safari.vercel.app">Strona Główna</a>
          </li>
          <li class="nav-item">
          <a className="nav-link" href="https://richi-safari.vercel.app/przed-wyjazdem">Przed wyjazdem</a>
          </li>
          <li class="nav-item">
          <a className="nav-link" href="https://richi-safari.vercel.app/oferta">Oferta</a>
          </li>
        </ul>
      </div>
    </div>
